      ...
      <div class="table-responsive">
        <table class="table table-condensed">
          ...
          <tr>
            ...
            <th scope="col">
              <a @click="sortby('comment')">Comment</a>
            </th>
            <th scope="col">
              <a>Created</a>
            </th>
          ...
          <tr v-for="(item, index) in items.data" :key="index">
            ...
            <td>
              <div style="display: flex; justify-content: space-between;">
                <nuxt-link class="btn_3 mt-0" :to="{name: 'admin-form-fill-id',  params: { id: item._id } }">Details</nuxt-link>
                <span> | </span>
...
<script>
  ...
  export default {
    ...
    asyncData({ params, error, $axios }) {
      return $axios.get(`/admin/form-fill`, {params: {max: 25}}).then((res) => {
    ...
    methods: {
       updateRead(obj){
        ...
        var request = obj;
          ...
          this.$axios.post(`/admin/form-fill/reviewed/${obj._id}`, request).then((res) => {
      ...
      exportFile: function(obj){
        this.$axios.get(`/admin/form-fill/export/excel`, {responseType: 'arraybuffer'}).then((res) => {
          if(res.data && !res.data.error){
      ...
      remove: function(obj){
        ...
        swal({title:"Remove", text:"Are you sure", icon:"info", buttons:['No','Yes']}).then(function(val){
          ...
          this.$axios.delete(`/admin/form-fill/${obj._id}`, request).then((res) => {
            if(res.data && !res.data.error){
      ...
      search: function(o) {
        ...
        this.$axios.get(`/admin/form-fill`, {params: request}).then((res) => {
