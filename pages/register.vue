    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-6 col-lg-6 col-md-8">
        <div class="box_account">
          ...
          <div class="form_container">
            <div class="form-group">
              <input type="email" class="form-control" v-model="form.user.email"  name="email" id="email" placeholder="Email*">
            </div>
            <div class="form-group">
            ...
            <div class="private box">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.name" placeholder="Company Name*">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.address" placeholder="Address*">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.address2" placeholder="Address 2">
                  </div>
                </div>
              </div>
              <div class="row no-gutters">
                <div class="col-6 pr-1">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.city" placeholder="City*">
                  </div>
                </div>
                <div class="col-6 pl-1">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.zip" placeholder="Postal Code*">
                  </div>
                </div>
                <div class="row no-gutters">
                  <div class="col-6 pr-1">
                    <div class="form-group">
                      <select class="form-control" name="state" id="state" v-model="form.company.state">
                  ...
                  <div class="col-6 pr-1">
                    <div class="form-group">
                      <select class="form-control" name="country" id="country" v-model="form.company.country">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="text" class="form-control" v-model="form.company.phone" placeholder="Telephone *">
                  </div>
                </div>
              </div>
              <!-- /row -->
            ...
            <div class="text-center"><input type="button" value="Register" class="btn_1 full-width" @click="register"></div>
          </div>
          <!-- /form_container -->
        </div>
        <!-- /box_account -->
